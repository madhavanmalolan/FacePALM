...
##
# Used to compose a URL from the article ID
UrlFromId = "%sindex.php?curid=%s"
...
def main():
    ...
    try:
        ...
        opts, args = getopt.gnu_getopt(sys.argv[1:], 'cb:hlo:B:sv', long_opts)
